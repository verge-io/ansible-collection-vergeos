...
"""Regression tests for the defects recorded in docs/DEFECTS-D1-D6.md.
...
# A real row, captured from conundrum-lab. Note what is NOT in it.
LIVE_DRIVE_ROW = {
...
def _drive_update(params, row=None):
    ...
    changed, _ = drive_mod.update_drive(module, MagicMock(), drive)
...
def test_d2_string_and_int_tiers_compare_equal():
    ...
    changed, _ = _drive_update({'tier': 1},
                               row={**LIVE_DRIVE_ROW, 'preferred_tier': '1'})
